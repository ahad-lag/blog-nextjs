...
const LikesListItem = ({ index , article }) => {
    console.log(index)
    return(
        <tr >
            ...
            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{index.article}</td>
            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{index.user}</td>
